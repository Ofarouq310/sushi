<div align="center">
  <br />
    <a href="https://youtu.be/QRrPE9aj3wI?feature=shared" target="_blank">
      <img src="https://github.com/Ofarouq310/sushi/blob/dev/src/assets/Moder%20UI.png" alt="Project Banner" width="800">
    </a>
  <br />
  ...
  <h3 align="center">Sushi Website</h3>
   ...
   <div align="center">
     A website that displays a menu of different sushi plates, including a menu in addition to a trending section which displays the top-rated Japanese sushi plates and drinks.
    </div>
</div>
...
Develop a sushi website using HTML and CSS with smooth, subtle animations showcasing popular food, trending sushi, and drinks. 
...
```bash
git clone https://github.com/Ofarouq310/sushi.git
cd sushi
```
...
A live project link is [here](https://sushi-seven-nu.vercel.app/)
